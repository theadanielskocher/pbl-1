...
Mã nguồn của đồ án được tổ chức thành 6 thành phần cốt lõi, bao gồm 1 tệp tiêu đề cơ sở, 4 cặp mô-đun logic (\texttt{.h} và \texttt{.cpp}) và một tệp điều khiển trung tâm. Chi tiết chức năng của từng tệp được quy định như sau:
...
Sơ đồ cấu trúc các hàm chính của chương trình có tạo Phụ lục B đính kèm theo báo cáo này.
...
\subsubsection{Giao diện chính của chương trình}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{Results/Main.png}
	\caption{Giao diện chính của chương trình}
\end{figure}
\subsubsection{Kết quả thực thi chương trình}
\begin{figure}[H]
	\centering
	% --- HÀNG 1 ---
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Results/ShowFamily.png}
		\caption{Hiển thị cây gia phả}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Results/Search.png}
		\caption{Tìm kiếm người trong gia phả}
	\end{subfigure}
	
	\caption{Tổng hợp các màn hình thực thi các chức năng chính của hệ thống quản lý gia phả}
\end{figure}

\begin{figure}[H]\ContinuedFloat
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Results/Relationship1.png}
		\caption{Kiểm tra quan hệ họ hàng giữa hai người}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Results/Relationship2.png}
		\caption{Tìm người theo quan hệ}
	\end{subfigure}
	
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Results/Update}
		\caption{Cập nhật thông tin cho cá nhân}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Results/Statistics}
		\caption{Thống kê gia phả}
	\end{subfigure}
	
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Results/InputFiles}
		\caption{Nhập gia phả từ file .txt}
	\end{subfigure}
	\caption{Tổng hợp các màn hình thực thi các chức năng chính của hệ thống quản lý gia phả \textit{(tiếp theo)}}
